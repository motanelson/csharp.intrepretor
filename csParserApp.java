...
public class csParserApp {
    ...
    public static void main(String[] args) {
        ...
        // ==========================
        if (args.length == 0) {
            System.out.println("Uso: java csParserApp <ficheiro.cs>");
            return;
        }
        ...
        try {
            ...
            csLexer lexer = new csLexer(charStream);
            ...
            for (Token token : tokens.getTokens()) {
                String name = csLexer.VOCABULARY.getSymbolicName(token.getType());
